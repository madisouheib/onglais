        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
                    <!-- Image -->
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url(website/img/ppl.jpg);">
                        <div class="position-absolute login-signup-content">
                            <div class="position-relative text-white col-md-12 col-lg-7">
                                ...
                                <p>We did not learn walking by following rules, but we learnt by falling and trying over and over again.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-6"><a href="{{ url('/teacher')}}" class="btn btn-info" style="color:#fff" > Teacher <i class="ti-user"></i> </a></div>
                     ...
                     <form method="POST" action="{{ route('register') }}"  class="login-signup-form">
                        ...
                        <input type="hidden" name="learner" value="1">
