        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
                    <!-- Image -->
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url(website/img/tech.jpg);">
                        <div class="position-absolute login-signup-content">
                            <div class="position-relative text-white col-md-12 col-lg-7">
                                ...
                                <p>In a world driven by technology, it is inevitable to integrate technology in learning/teaching contexts. However, the teacher was, is, and always will play a crucial role.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-6"><a href="{{ url('/learner')}}" style="color:#fff" class="btn btn-info "> Learner  <i class="ti-pencil"></i> </a> </div>
<div class="col-6"><a href="{{ url('/teacher')}}" class="btn btn-info" style="color:#fff" > Teacher <i class="ti-user"></i> </a></div>
...
@csrf
                              ...
                              <input type="hidden" name="learner" value="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select name="gendre" placeholder="Enter your language" class="form-control"> 
...
<option>  Female </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <div class="input-icon">
                                        <span class="ti-marker color-primary"></span>
                                    </div>
                                

                                    <select required name="lang" placeholder="Enter your language" class="form-control"> 
<option selected> Please select </option>
<option value="1"> ENGLISH </option>
<option value="2"> FRENSH </option>
<option value="3"> SPANISH </option>
<option value="4"> GEMRANY </option>
...
<div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <div class="input-icon">
                                        <span class="ti-thumb-up color-primary"></span>
                                    </div>
                                

                                    <select required name="reason" placeholder="Enter your language" class="form-control"> 
<option selected> Please select </option>
<option value="1"> While you still studying </option>
<option value="2"> as a graduate </option>
<option value="3"> as a self learner </option>
...
<div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <div class="input-icon">
                                        <span class="ti-map-alt color-primary"></span>
                                    </div>
