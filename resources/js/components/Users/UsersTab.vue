...
<div> 
    ...
    <select class="form-control "  v-model="idlang" @change="GetFiltreUsers(idlang)">
    ...
    <select class="form-control"  v-model="contr">
       <option selected value="0"> ALL</option>
...
<div class="col-sm-4  ">                                                 
<button class=" btn btn-sm btn-glow-info btn-info">  <i style="margin-right: -2px;" class="fas fa-edit"></i> </button>
...
<pagination :data="users" :limit="2" @pagination-change-page="GetUsers">
                                        </pagination>
                                            </div>
...
GetUsers(page = 1,idlang)
 {
     ...
     axios.get('/api/getusers/?page='+page)
     .then(response =>
     { 
 ...
 GetFiltreUsers(idlang)
 {


     axios.get('/api/getfiltreusers/'+idlang)
     .then(response =>
     { 
